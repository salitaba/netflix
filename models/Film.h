...
class Film {
 public:
  Film(std::string _name, std::string _year, std::string _length,
       std::string _price, std::string _summary, std::string _director, int id,
       User* _aurtor);

  void setDetail(std::string _name, std::string _year, std::string _length,
                 std::string _price, std::string _summary,
                 std::string _director);
  bool isId(int id);
  bool isUser(User* user);
  void unusable();
  bool find(std::string name, std::string minYear, std::string minRate,
  ...
  std::string getName();
  bool isUsable();
  std::map<std::string, std::string> getDetail();
